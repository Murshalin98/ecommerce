...
<form method="POST" action="{{ route('password.email') }}">
    ...
    <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">{{ __('Reset Password') }} <hr></div>
            @if (session('status'))
        ...
        <div class="mg-t-60 tx-center">Back to Login ? <a href="{{ route('login') }}" class="tx-info">Sign In</a></div>
      </div>
</form>
