        ...
        <div class="row">
            <div class="col-lg-9 col-12">
                <div class="blog-details-wrap">
                    <img src="{{asset('blogs/images/'. $blog->featured_image)}}" alt="{{$blog->title}}">
                    <h3>{{$blog->title}}</h3>
                    <ul class="meta">
                ...
                <aside class="sidebar-area">
                    <div class="widget widget_categories">
                        ...
                        <ul>
                            @foreach ($categories as $category)
                                <li><a href="#">{{$category->name}} ({{$category->blog->count()}})</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="widget widget_recent_entries recent_post">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="post-img">
                                    <img width="70" height="70" src="{{asset('blogs/thumbnail/'. $post->thumbnail)}}" alt="">
                                </div>
