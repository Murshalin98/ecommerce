                ...
                <ul class="row">
                    ...
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            <div class="product-img">
                                <span>Sale</span>
                                <img src="{{ asset('products/thumbnail/'. $product->thumbnail) }}" alt="{{ $product->title }}">
                                <div class="product-icon flex-style">
                                    <ul>
                                        <li><a data-toggle="modal" data-target="#exampleModalCenter{{ $product->id }}" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                        <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="{{ route('SingleCart', $product->id) }}"><i class="fa fa-shopping-bag"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="product-content">
                                <h3><a href="{{ route('ProductsDetails', $product->slug ) }}" target="_blank">{{ $product->title }}</a></h3>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex">
                                    ...
                                    <div class="product-single-content w-50">
                                        ...
                                        <p>{{ Str::limit($product->summary, 100, ' .... ..') }}</p>
                                        ...
                                        <ul class="cetagory">
                                            ...
                                            <li>
                                                <a>
                                                    @foreach (App\Models\Products_Attribute::where('product_id', $product->id)->get() as $color)
                                                        <li>{{$color->get_color->color_name}} @if (!$loop->last), @endif</li>
                                                    @endforeach
                                                </a>
                                            </li>
                                        </ul>
                                        <ul class="socil-icon">
                                            <li>Share :</li>
                                            <li><a href="https://web.facebook.com/sharer/sharer.php?u={{ route('ProductsDetails', $product->slug ) }}" target="_blank"><i class="fa fa-facebook"></i></a></li>
